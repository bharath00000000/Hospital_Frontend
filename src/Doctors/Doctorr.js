...
function Doctorr() {
  ...
  const handleAddDoctor = (newDoctor) => {
    ...
    axios.post('http://3.110.158.87:5000/doctors', newDoctor)
      .then((response) => {
  ...
  const handleDeleteDoctor = (doctorId) => {
    ...
    axios.delete(`http://3.110.158.87:5000/doctors/${doctorId}`)
      .then(() => {
  ...
  const handleEditDoctor = (editedDoctor) => {
    ...
    axios.put(`http://3.110.158.87:5000/doctors/${editedDoctor.id}`, editedDoctor)
      .then(() => {
