...
function Patient() {
  ...
  const handleAddPatient = (newPatient) => {
    ...
    axios.post('http://3.110.158.87:5000/patients', newPatient)
      .then((response) => {
  ...
  const handleDeletePatient = (PatientId) => {
    ...
    axios.delete(`http://3.110.158.87:5000/Patients/${PatientId}`)
      .then(() => {
  ...
  const handleEditPatient = (editedPatient) => {
    ...
    axios.put(`http://3.110.158.87:5000/Patients/${editedPatient.id}`, editedPatient)
      .then(() => {
